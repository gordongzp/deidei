...
<div class="login-layout">
	...
	<form method="post" id="form_login">
		...
		<div class="avatar"><img src="/Public/Admin/images/admin_avatar.jpg" alt=""></div>
		<div class="submit"> 
			<span>
				<div class="code">
					<div class="arrow"></div>
	...
	<div class="bottom">
		<h5>Powered by <span class="vol"><font class="b">YIJIANSPORTS</font></span></h5>
		<h6 title="中山一建体育用品有限公司">© 2007-2015 <a href="http://www.yijiansports.com" target="_blank">Yijiansports Networking Inc.</a></h6>
	</div>
</div>
<script>
$(function(){
       /* $.supersized({
        ...
        slide_links        : 'blank',    
        slides             : [    
                                 {image : 'http://b2b2c.shopnctest.com/tesa/shopnc/templates/default/images/login/1.jpg'},
                                 {image : 'http://b2b2c.shopnctest.com/tesa/shopnc/templates/default/images/login/2.jpg'},
                                 {image : 'http://b2b2c.shopnctest.com/tesa/shopnc/templates/default/images/login/3.jpg'},
								 {image : 'http://b2b2c.shopnctest.com/tesa/shopnc/templates/default/images/login/4.jpg'},
								 {image : 'http://b2b2c.shopnctest.com/tesa/shopnc/templates/default/images/login/5.jpg'}
                       ]
    ...
    if ($.browser.msie && ($.browser.version=="6.0" || $.browser.version=="7.0")){
        window.location.href='http://b2b2c.shopnctest.com/tesa/shopnc/templates/default/ie6update.html';
    }
