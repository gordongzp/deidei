		...
		<form id="add_form" method="post" enctype="multipart/form-data">
			...
			<div class="ncap-form-default">
				...
				<dl class="row">
					...
					<dd class="opt">
						<div class="onoff">
							<label class="cb-enable <?php if(($is_rotate) == "true"): ?>selected<?php endif; ?>" for="is_rotate1">开</label>
							<label class="cb-disable <?php if(($is_rotate) == "false"): ?>selected<?php endif; ?>" for="is_rotate0">关</label>
					...
					<dd class="opt">
						<input type="text" id="rotate_speed" name="rotate_speed" value="<?php echo ($rotate_speed); ?>" class="w60">
						<span class="err"></span>
					...
					<dd class="opt">
						<input type="text" id="wait_time" name="wait_time" value="<?php echo ($wait_time); ?>" class="w60">
						<span class="err"></span>
